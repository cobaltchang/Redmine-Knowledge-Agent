...
class TestMarkdownGenerator:
    ...
    def test_journals_section_with_multiple_entries(
        ...
        journals = [
            JournalEntry(
                ...
                user="User A",
                notes="First comment",
                created_on=datetime(2024, 1, 10, 10, 0),
            ),
            JournalEntry(
                id=2,
                user="User B",
                notes="Second comment",
                created_on=datetime(2024, 1, 11, 11, 0),
            ),
        ]
    ...
    def test_various_processing_methods(
        ...
        methods = [
            ...
            (ProcessingMethod.TEXT_EXTRACT, "提取"),
            (ProcessingMethod.LLM, "AI"),
            (ProcessingMethod.FALLBACK, "提取"),
        ]
    ...
    def test_journals_section_filters_empty_notes(
        ...
        journals = [
            JournalEntry(
                ...
                created_on=datetime(2024, 1, 10),
            ),
            JournalEntry(
                id=2,
                user="User B",
                notes="Real comment",
                created_on=datetime(2024, 1, 11),
            ),
        ]
