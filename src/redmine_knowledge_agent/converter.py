...
class TextileConverter:
    ...
    def convert(self, textile: str) -> str:
    ...
    def _convert_code_blocks(self, text: str) -> str:
        ...
        def replace_with_lang(match: re.Match) -> str:
    ...
    def _convert_images(self, text: str) -> str:
        ...
        """
        def replace_image_with_alt(match: re.Match) -> str:
            src = match.group(1)
            alt = match.group(2)
        ...
        def replace_image_simple(match: re.Match) -> str:
            src = match.group(1)
