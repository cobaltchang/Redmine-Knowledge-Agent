...
from .config import OutputConfig, RedmineConfig
...
class RedmineClient:
    ...
    def get_project_issues(
        ...
        try:
            ...
            for issue in issues:  # pragma: no branch
                ...
                if updated_after and hasattr(issue, "updated_on"):  # pragma: no branch
                    if issue.updated_on <= updated_after:
                        continue
    ...
    def get_issue(self, issue_id: int) -> IssueMetadata:
        ...
        try:
            ...
            logger.error("Failed to fetch issue", issue_id=issue_id, error=str(e))
            raise
